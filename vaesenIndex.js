const pdfDirectory = [
    {
        name: "Core Book", code: "RULES", directory: [
            ["INTRODUCTION", [
                ["Introduction to Vaesen", 6],
                ["This Book", 7],
                ["Vaesen in a Nutshell", 10],
            ]],
            ...
            ["THE MYTHIC NORTH AND UPSALA", [
                ["Your Mythic North", 98],
                ["Upsala – Science and Fairytales", 105],
            ]],
            ["VAESEN", [
                ["Vaesen and Humans", 112],
                ["Magical Powers", 115],
                ["Rules for Vaesen", 121],
                ["Non-Player Characters", 166],
                ["Animals", 168],
                ["The Vaesen of the World", 168],
            ]],
            ["THE MYSTERY", [
                ["The Components of the Mystery", 172],
                ["The Structure of the Mystery", 179],
                ["Mystery Tables", 188],
                ["Campaign", 192],
                ["Gamemaster Techniques", 193],
            ]],
            ["THE DANCE OF DREAMS", [
                ["Prelude", 196],
                ["Places", 202],
            ...
            ["BACKGROUND TABLES", 214],
        ]
    },
    {
        name: "Solo Investigator's Handbook", code: "SOLOI", directory: [
            ["Introduction", 1],
            ["Generate a Scenario", 10],
            ["Journalling", 19],
            ["NPCs", 28],
            ["Mythos Creatures", 35],
            ["The Verbs Table", 40],
...
const toolsDirectory = [
    {
        name: "Generators", directory: [
            ...
            ["Fantasy Name Generator: Swedish", "https://www.fantasynamegenerators.com/swedish-names.php#result"],
...
class VaesenIndex extends Application {
    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            title: "Index",
            width: 320,
